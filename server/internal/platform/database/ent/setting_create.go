...
func (_c *SettingCreate) SetMail(v *schema.MailSettings) *SettingCreate {
	_c.mutation.SetMail(v)
	return _c
}

// SetUniqueID sets the "unique_id" field.
func (_c *SettingCreate) SetUniqueID(v string) *SettingCreate {
...
func (_c *SettingCreate) check() error {
	if _, ok := _c.mutation.UniqueID(); !ok {
		return &ValidationError{Name: "unique_id", err: errors.New(`ent: missing required field "Setting.unique_id"`)}
	}
	return nil
}
...
func (_c *SettingCreate) createSpec() (*Setting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Mail(); ok {
