...
func (_u *SettingUpdate) SetMail(v *schema.MailSettings) *SettingUpdate {
	_u.mutation.SetMail(v)
	return _u
}

// ClearMail clears the value of the "mail" field.
func (_u *SettingUpdate) ClearMail() *SettingUpdate {
	_u.mutation.ClearMail()
	return _u
}

// SetUniqueID sets the "unique_id" field.
func (_u *SettingUpdate) SetUniqueID(v string) *SettingUpdate {
	_u.mutation.SetUniqueID(v)
	return _u
}

// SetNillableUniqueID sets the "unique_id" field if the given value is not nil.
func (_u *SettingUpdate) SetNillableUniqueID(v *string) *SettingUpdate {
	if v != nil {
		_u.SetUniqueID(*v)
	}
	return _u
...
func (_u *SettingUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Mail(); ok {
		_spec.SetField(setting.FieldMail, field.TypeJSON, value)
	}
	if _u.mutation.MailCleared() {
		_spec.ClearField(setting.FieldMail, field.TypeJSON)
	}
	if value, ok := _u.mutation.UniqueID(); ok {
		_spec.SetField(setting.FieldUniqueID, field.TypeString, value)
	}
...
// SetMail sets the "mail" field.
func (_u *SettingUpdateOne) SetMail(v *schema.MailSettings) *SettingUpdateOne {
	_u.mutation.SetMail(v)
	return _u
}

// ClearMail clears the value of the "mail" field.
func (_u *SettingUpdateOne) ClearMail() *SettingUpdateOne {
	_u.mutation.ClearMail()
	return _u
}

// SetUniqueID sets the "unique_id" field.
func (_u *SettingUpdateOne) SetUniqueID(v string) *SettingUpdateOne {
	_u.mutation.SetUniqueID(v)
	return _u
}

// SetNillableUniqueID sets the "unique_id" field if the given value is not nil.
func (_u *SettingUpdateOne) SetNillableUniqueID(v *string) *SettingUpdateOne {
	if v != nil {
		_u.SetUniqueID(*v)
	}
	return _u
