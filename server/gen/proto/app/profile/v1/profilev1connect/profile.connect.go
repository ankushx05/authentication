...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ankushx05/authentication/gen/proto/app/profile/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProfileServiceName = "app.profile.v1.ProfileService"
)
...
const (
	...
	// RPC.
	ProfileServiceGetProfileProcedure = "/app.profile.v1.ProfileService/GetProfile"
)

// ProfileServiceClient is a client for the app.profile.v1.ProfileService service.
type ProfileServiceClient interface {
	GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error)
}

// NewProfileServiceClient constructs a client for the app.profile.v1.ProfileService service. By
...
func NewProfileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProfileServiceClient {
	...
	profileServiceMethods := v1.File_app_profile_v1_profile_proto.Services().ByName("ProfileService").Methods()
...
// GetProfile calls app.profile.v1.ProfileService.GetProfile.
...
// ProfileServiceHandler is an implementation of the app.profile.v1.ProfileService service.
...
func NewProfileServiceHandler(svc ProfileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app.profile.v1.ProfileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProfileServiceHandler) GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.profile.v1.ProfileService.GetProfile is not implemented"))
}
